...
@implementation GreeJSStartLoadingCommand
...
- (void)execute:(NSDictionary *)params
{
  ...
  if ([self.delegate respondsToSelector:@selector(stateCommandStartLoading)]) {
    [self.delegate performSelector:@selector(stateCommandStartLoading)];
  }
}
@end
