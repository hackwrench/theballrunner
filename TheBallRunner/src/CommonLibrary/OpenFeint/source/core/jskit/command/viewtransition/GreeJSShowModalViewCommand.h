...
typedef enum {
  kModalTypeModalView,
  kModalTypeInputTextView,
  kModalTypeInputTextViewCancel
} ModalType;

@interface GreeJSShowModalViewCommand : GreeJSPushViewCommand
...
@interface NSObject(GreeJSShowModalViewCommandDelegate)
