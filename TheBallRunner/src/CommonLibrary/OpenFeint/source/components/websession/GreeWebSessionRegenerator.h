...
@protocol GreePopupURLHandlerDelegate;


typedef void (^GreeWebSessionRegeneratorShowHttpErrorBlock)(NSError* error);

@interface GreeWebSessionRegenerator : NSObject
