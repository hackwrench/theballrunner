...
#define errorPageBaseURL @"about://error/"

typedef enum {
  GreeWebViewUrlLabelPositionTop,
  GreeWebViewUrlLabelPositionBottom
} GreeWebViewUrlLabelPosition;

@interface UIWebViewErrorPageRequest
@end

@interface UIWebView (GreeAdditions)
