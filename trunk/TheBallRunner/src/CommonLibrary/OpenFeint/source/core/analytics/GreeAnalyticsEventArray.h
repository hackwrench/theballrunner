...
@interface GreeAnalyticsEventArray : NSArray
{
    NSMutableArray* objects;
}
@property (nonatomic, assign, readonly) NSRange rangeOfMarkedEvents;
@property (nonatomic, assign, readwrite) NSTimeInterval maximumStorageTime;
+ (id)events;
- (id)init;
