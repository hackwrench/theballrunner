...
@implementation GreeJSReadyCommand
...
- (void)execute:(NSDictionary *)params
{
  ...
  if ([self.delegate respondsToSelector:@selector(stateCommandReady)]) {
    [self.delegate performSelector:@selector(stateCommandReady)];
  }
}
