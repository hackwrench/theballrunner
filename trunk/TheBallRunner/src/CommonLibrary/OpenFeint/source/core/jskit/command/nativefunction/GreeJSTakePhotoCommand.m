...
@implementation GreeJSTakePhotoCommand
...
- (void)execute:(NSDictionary *)params
{
  ...
  if ([currentViewController respondsToSelector:@selector(greeJSShowTakePhotoSelector:)])
  {
    [currentViewController performSelector:@selector(greeJSShowTakePhotoSelector:) withObject:params];
  }
}
