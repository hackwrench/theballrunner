...
@interface GreeDashboardViewController : GreeMenuNavController <UINavigationControllerDelegate, GreeMenuNavControllerDelegate,GreeDashboardViewControllerDelegate>

@property (nonatomic, retain) UIBarButtonItem* closeButton;
@property (nonatomic, retain) UIBarButtonItem* notificationButton;
